...
import {
  createBotSetting,
  updateBotSetting,
} from "#controllers/admin/bot_setting.controller";
import {
  clearData,
  deleteUser,
  deleteUserOrders,
...
import {
  botsActivity,
  deleteBot,
} from "#controllers/admin/bot_admin.controller";
...
adminRouter.get(
  "/profit_loss/dashboard",
  [authMiddleware, admin],
  getProfitLossDashboard
);
adminRouter.get(
  "/profit_loss/statistics",
  [authMiddleware, admin],
  getProfitLossStatistics
);
